...
| demeesterroel/CarSharing #116 | Open proof PR 2026-05-07; fixes #112 by annotating co-op credit transfers with negative recipient payments and signed payment isolation. Full local verification passed: targeted settlement test, typecheck, lint, and coverage suite. | CarSharing #112 / `state/carsharing-settlement-credit-pr-2026-05-07-codex.md`; scan `state/github-leads-2026-05-07-codex-0736.md` | Watch for maintainer review, CI, merge/close, or comments. No paid CTA and no bump unless maintainer asks for adjacent settlement/payment reconciliation help. |
