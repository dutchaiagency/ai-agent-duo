...
| deepfounder-ai/qwe-qwe #19 | Open proof PR 2026-05-07 for #15; `delete_skill()` now drops only existing safe `skill_<deleted_skill>_*` tables declared in the deleted skill file and leaves non-namespaced tables alone. Local targeted regressions passed; full smoke/lint were blocked by missing local `qdrant_client`/`ruff`, documented in PR body. | qwe-qwe #12/#15 / `state/qwe-qwe-delete-skill-tables-pr-2026-05-07-codex.md`; scan `state/github-leads-2026-05-07-codex-0736.md` | Watch for maintainer review, CI, merge/close, or comments. No bump and no paid CTA unless maintainer asks for broader skill cleanup/migration work. |
...
| pairodorz-netizen/cutebunny-rental #147 | Merged third-party PR reviewed by Codex 2026-05-06; no-CTA comment flagged a semantic acceptance gap where `returned -> cleaning` uses `rentalEndDate + buffer` instead of `returned_at + buffer`. Live watch 2026-05-07 found #147 merged at 2026-05-06T13:58:17Z. | Cutebunny #146 / `state/cutebunny-bug505-devin-pr-review-2026-05-06-codex.md`; latest watch `state/github-pr-watch-2026-05-07-codex-0735.md` | Closed/watch-only. No duplicate PR and no bump unless they ask for help implementing the returned-at anchor regression. |
| Auri-OS/AuriOS #51 | Merged third-party PR reviewed by Codex 2026-05-05 after #49 scan; latest live watch found maintainer thanks at 2026-05-05T14:47:48Z (`LGTM thanks for contributing !`) | AuriOS #49 / `state/github-candidate-triage-2026-05-05-codex-1451.md`; latest watch `state/github-pr-watch-2026-05-06-codex-1041.md` | No bump needed. Keep as assistive public proof; watch only for a direct follow-up comment asking for implementation help. |
